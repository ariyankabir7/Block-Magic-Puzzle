...
import com.block.gamecraft.adapter.playearnAdapter
import com.block.gamecraft.databinding.ActivityPlayEarnTaskListBinding
import com.block.gamecraft.modal.PlayEarnModal
...
class PlayEarnTaskListActivity : AppCompatActivity() {
    ...
    fun  getPlayEarnTask(){
        ...
        val url = "${com.block.gamecraft.Companion.siteUrl}get_playearn_tasklist.php"
