...
import com.block.gamecraft.databinding.ActivityMainBinding
...
//        }
    ...
    fun getOCROffers() {
        ...
        val url =
            "${com.block.gamecraft.Companion.siteUrl}get_ocr_joining_task_details.php?email=$emails&app_id=$appId"
