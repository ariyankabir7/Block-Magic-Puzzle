...
import com.block.gamecraft.databinding.ActivityHomeBinding
...
class HomeActivity : AppCompatActivity() {
    ...
    private fun getUserValue() {
        ...
        val url2 = "${com.block.gamecraft.Companion.siteUrl}getuservalue.php"
        ...
        val stringRequest =
            object : StringRequest(Method.POST, url2, { response ->
                ...
                if (res.contains(",")) {
                    ...
                    binding.tvPlayerId.text = TinyDB.getString(this, "phone", "")
                    if (alldata[2].toInt() > com.block.gamecraft.Companion.APP_VERSION) {
                        showUpdatePopup()
                    } else if (alldata[1] == "1") {
                        showMaintaincePopup()
                    }
