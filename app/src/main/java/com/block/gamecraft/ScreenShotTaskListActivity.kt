...
import com.block.gamecraft.adapter.screenshotAdapter
import com.block.gamecraft.databinding.ActivityScreenShotTaskListBinding
import com.block.gamecraft.modal.ScreenshotModal
...
class ScreenShotTaskListActivity : AppCompatActivity() {
    ...
    fun  getscreenShotTask() {
        ...
        val appId = Base64.getEncoder().encodeToString(com.block.gamecraft.Companion.APP_ID.toString().toByteArray())

        val url = "${com.block.gamecraft.Companion.siteUrl}get_screenshot_tasklist.php?email=$emails&app_id=$appId"
