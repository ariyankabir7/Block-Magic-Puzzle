...
import com.block.gamecraft.adapter.RedeemAdapter
import com.block.gamecraft.databinding.ActivityWithdrawalOptionBinding
import com.block.gamecraft.modal.RedeemModal
...
class Withdrawal_OptionActivity : AppCompatActivity() {
    ...
    private fun fetchDataFromServer() {
        ...
        val url = "${com.block.gamecraft.Companion.siteUrl}get_withdrawal_options.php"
