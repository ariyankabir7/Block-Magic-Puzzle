...
import com.block.gamecraft.adapter.earningwallAdapter
import com.block.gamecraft.databinding.ActivityEarningWallTaskListBinding
import com.block.gamecraft.modal.EarningwallModal
...
class EarningWallTaskListActivity : AppCompatActivity() {
    ...
    private fun getEarningWallTask() {
        ...
        val url = "${com.block.gamecraft.Companion.siteUrl}get_earningwall_tasklist.php"
