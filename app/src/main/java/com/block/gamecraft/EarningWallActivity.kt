...
import com.block.gamecraft.databinding.ActivityEarningWallBinding
...
class EarningWallActivity : AppCompatActivity() {
    lateinit var binding: ActivityEarningWallBinding
    init {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityEarningWallBinding.inflate(layoutInflater)
            ...
            when (event.action) {
                ...
                MotionEvent.ACTION_UP -> {
                    ...
                    if (binding.cbRead.isChecked) {
                        startActivity(Intent(this, EarningWallTaskListActivity::class.java))
                    } else {
    ...
    fun getEarningwallnvalue(){
        ...
        val url2 =
            "${com.block.gamecraft.Companion.siteUrl}get_earningwall_config.php"
