...
import com.block.gamecraft.databinding.ActivityReferBinding
...
class ReferActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvReferLink.text = "https://gamecraft.fun/gameui50/refer/?code=${TinyDB.getString(this, "refer_code", "")}&app_id=${com.block.gamecraft.Companion.APP_ID}"
