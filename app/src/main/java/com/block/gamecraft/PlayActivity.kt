...
import com.block.gamecraft.databinding.ActivityPlayBinding
...
class PlayActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupWebView()
        webView.loadUrl("https://304-freeonline-play.gamesdonut.com/game/Block-Puzzle")
    ...
    fun addPlayPoint() {
        if (TinyDB.getString(this, "play_limit", "0") == "0") {
            ...
            val url3 = "${com.block.gamecraft.Companion.siteUrl}add_play_point.php"
    ...
    private fun setupWebView() {
        ...
        webView.webViewClient = object : WebViewClient() {
            override fun shouldOverrideUrlLoading(view: WebView?, request: WebResourceRequest?): Boolean {
                ...
                val targetUrl = "https://304-freeonline-play.gamesdonut.com/game/Block-Puzzle"
