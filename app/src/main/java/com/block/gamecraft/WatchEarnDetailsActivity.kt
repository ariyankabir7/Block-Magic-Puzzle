...
import com.block.gamecraft.adapter.AdsCompanyAdapter
import com.block.gamecraft.databinding.ActivityWatchEarnDetailsBinding
import com.block.gamecraft.extrazz.CustomAdLoader
import com.block.gamecraft.modal.CompanyAdsModal
import com.block.gamecraft.services.MusicService
...
class WatchEarnDetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adloder = CustomAdLoader(
            context = this,
            siteAdsUrl = com.block.gamecraft.Companion.siteAdsUrl,
            uniqueAppId = com.block.gamecraft.Companion.ADS_UNIQUE_APP_ID,
            onAdDismiss = {
                claimCoin()
            }
        )
    ...
    fun getWatchearnvalue() {
        ...
        val url2 =
            "${com.block.gamecraft.Companion.siteUrl}get_watchearn_config.php"
    ...
    fun getadsCompamy() {
        ...
        val url = "${com.block.gamecraft.Companion.siteUrl}get_company_ads_list.php"
    ...
    private fun claimCoin() {
        ...
        val url2 = "${com.block.gamecraft.Companion.siteUrl}earning_ads_point.php"
