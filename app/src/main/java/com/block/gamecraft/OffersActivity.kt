...
import com.block.gamecraft.databinding.ActivityOffersBinding
import com.block.gamecraft.modal.EarningAdModel
...
class OffersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val offerWallConfig =
            OfferWallConfig.Builder(this, com.block.gamecraft.Companion.PUBSCALE_APP_ID)
                .setUniqueId(
                    TinyDB.getString(
                        this,
                        "phone",
                        ""
                    )!! + "-" + com.block.gamecraft.Companion.APP_ID
                )
        ...
        binding.llTimewall.setOnTouchListener { v, event ->
            ...
            when (event.action) {
                ...
                MotionEvent.ACTION_UP -> {
                    ...
                    val url = "${com.block.gamecraft.Companion.timewallUrl}$email-${com.block.gamecraft.Companion.APP_ID}"
    ...
    private fun loadEarningAd() {
        ...
        val urlforAds =
            "${com.block.gamecraft.Companion.siteAdsUrl}get_ad.php"
    ...
    fun updateImpression() {
        ...
        val url3 = "${com.block.gamecraft.Companion.siteAdsUrl}u_i.php"
        ...
        val stringRequest = object : StringRequest(Method.POST, url3, { response ->
            ...
            override fun getParams(): Map<String, String> {
                ...
                val uapp_id32 =
                    videoplayyer.encrypt(com.block.gamecraft.Companion.ADS_UNIQUE_APP_ID, Hatbc())
                        .toString()
    ...
    fun updateClick() {
        ...
        val url3 = "${com.block.gamecraft.Companion.siteAdsUrl}u_c.php"
        val queue3: RequestQueue = Volley.newRequestQueue(this)
